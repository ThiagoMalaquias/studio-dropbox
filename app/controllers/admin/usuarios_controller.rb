class Admin::UsuariosController < Admin::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @usuario.save
        format.html { redirect_to admin_usuario_url(@usuario), notice: "Usuario was successfully created." }
  ...
  def update
    respond_to do |format|
      if @usuario.update(usuario_params)
        format.html { redirect_to admin_usuario_url(@usuario), notice: "Usuario was successfully updated." }
