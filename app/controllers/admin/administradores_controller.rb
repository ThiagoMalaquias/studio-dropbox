  ...
  def create
    ...
    respond_to do |format|
      if @administrador.save
        format.html { redirect_to admin_administrador_url(@administrador), notice: "Administrador was successfully created." }
  ...
  def update
    respond_to do |format|
      if @administrador.update(administrador_params)
        format.html { redirect_to admin_administrador_url(@administrador), notice: "Administrador was successfully updated." }
